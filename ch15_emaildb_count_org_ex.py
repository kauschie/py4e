...
# program, there is a balance between the number of operations you execute between commits and the importance 
...
for line in fh:
    ...
    pieces = line.split()
    email = pieces[1]
    # uses regular expression to pull out domain name and returns the string using index operator
...
sqlstring = cur.execute('SELECT org, count FROM Counts ORDER BY count DESC LIMIT 10')
